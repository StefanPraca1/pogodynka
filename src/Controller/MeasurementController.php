...
{
    // Uwaga: tutaj NIE powielamy prefiksu '/measurement' – zostawiamy pustą ścieżkę
    ...
    {
        // Pomiary pobierane wraz z Location (fetch join) – jak wcześniej
        $measurements = $measurementRepository->findAllWithLocation();
